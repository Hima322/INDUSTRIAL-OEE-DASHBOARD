<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="maintenance_delay.aspx.cs" Inherits="WebApplication2.andon.MaintenanceDelay" %>
...
<head runat="server">
    ...
    <script>
        ...
        const getOperatorDelay = () => {
            $.ajax({
                type: "POST",
                url: "maintenance_delay.aspx/GetOperatorDelay",
                data: "",
