<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="operator_delay.aspx.cs" Inherits="WebApplication2.andon.OperatorDelay" %>
...
<head runat="server">
    ...
    <script>
        ...
        const getOperatorDelay = () => {
            $.ajax({
                type: "POST",
                url: "operator_delay.aspx/GetOperatorDelay",
                data: "",
