<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="quality_delay.aspx.cs" Inherits="WebApplication2.andon.Quality_delay" %> 
...
<head runat="server">
    ...
    <script>
        ...
        const getQualityDelay = () => {
            $.ajax({
                type: "POST",
                url: "quality_delay.aspx/GetQualityDelay",
                data: "",
