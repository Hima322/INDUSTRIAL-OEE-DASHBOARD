...
{
    public partial class MaterialDelay : System.Web.UI.Page
    {
        ...
        public static string GetOperatorDelay()
        {
            try
            {
                ...
                {
                    var listRes = entity.DelayRecords.Where(i => i.DelayType == "MaterialDelay" && i.DelayTime > DateTime.Today).ToList();
