...
{
    public partial class MaintenanceDelay : System.Web.UI.Page
    {
        ...
        public static string GetOperatorDelay()
        {
            try
            {
                ...
                {
                    var listRes = entity.DelayRecords.Where(i => i.DelayType == "MaintenanceDelay" && i.DelayTime > DateTime.Today).ToList();
