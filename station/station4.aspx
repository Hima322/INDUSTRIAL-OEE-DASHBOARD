<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="station4.aspx.cs" Inherits="WebApplication2.station.Station4" %> 
...
<head runat="server">
    ...
    <script> 
        ...
        const isConveyorAutoMode = _ => {
            $.ajax({
                type: "POST",
                url: "station4.aspx/IS_CONVEYOR_AUTO_MODE",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const pageLoadFunction = _ => {
            $.ajax({
                type: "POST",
                url: "station4.aspx/PAGE_LOAD_FUNCTION",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getJobCount = _ => {
            $.ajax({
                type: "POST",
                url: "station4.aspx/GET_JOB_COUNT",
        ...
        const callStationInfo = _ => {
            $.ajax({
                type: "POST",
                url: "station4.aspx/GetStationInfo",
                data: `{station : '${station}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getCurrentUser = _ => {
            $.ajax({
                type: "POST",
                url: "station4.aspx/GetCurrentUser",
        ...
        const getModelAndTaskList = _ => {
            $.ajax({
                type: "POST",
                url: "station4.aspx/GetModelAndTaskList",
        ...
        const buildTicketExecuteTask = (id, value) => {
            $.ajax({
                type: "POST",
                url: "station4.aspx/BuildTicketExecuteTask",
        ...
        const getAllPlcTagList = _ => {
            $.ajax({
                type: "POST",
                url: "station4.aspx/GetAllPlcTagList",
                data: "",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const writeBitExecuteTask = id => {
            $.ajax({
                type: "POST",
                url: "station4.aspx/WriteBitExecuteTask",
        ...
        const readBitExecuteTask = id => {
            $.ajax({
                type: "POST",
                url: "station4.aspx/ReadBitExecuteTask",
        ...
        function isPlcConnected() {
            $.ajax({
                type: "POST",
                url: "station4.aspx/IS_PLC_CONNECTED",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
