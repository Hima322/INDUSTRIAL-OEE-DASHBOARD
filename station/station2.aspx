<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="station2.aspx.cs" Inherits="WebApplication2.station.Station2" %> 
...
<head runat="server">
    ...
    <script> 
        ...
        const isConveyorAutoMode = _ => {
            $.ajax({
                type: "POST",
                url: "station2.aspx/IS_CONVEYOR_AUTO_MODE",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const pageLoadFunction = _ => {
            $.ajax({
                type: "POST",
                url: "station2.aspx/PAGE_LOAD_FUNCTION",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getJobCount = _ => {
            $.ajax({
                type: "POST",
                url: "station2.aspx/GET_JOB_COUNT",
        ...
        const callStationInfo = _ => {
            $.ajax({
                type: "POST",
                url: "station2.aspx/GetStationInfo",
                data: `{station : '${station}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getModelAndTaskList = _ => {
            $.ajax({
                type: "POST",
                url: "station2.aspx/GetModelAndTaskList",
        ...
        const buildTicketExecuteTask = (id, value) => {
            $.ajax({
                type: "POST",
                url: "station2.aspx/BuildTicketExecuteTask",
        ...
        const torqueExecuteTask = (id, torque_seq) => {  
            if (EntryPoint) {
                ...
                $.ajax({
                    type: "POST",
                    url: "station2.aspx/TorqueExecuteTask",
        ...
        const getAllPlcTagList = _ => {
            $.ajax({
                type: "POST",
                url: "station2.aspx/GetAllPlcTagList",
                data: "",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const writeBitExecuteTask = id => {
            $.ajax({
                type: "POST",
                url: "station2.aspx/WriteBitExecuteTask",
        ...
        function isPlcConnected() {
            $.ajax({
                type: "POST",
                url: "station2.aspx/IS_PLC_CONNECTED",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
