<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="station9.aspx.cs" Inherits="WebApplication2.station.Station9" %> 
...
<head runat="server">
    ...
    <script> 
        ...
        const callStationInfo = _ => {
            $.ajax({
                type: "POST",
                url: "station9.aspx/GetStationInfo",
                data: `{station : '${station}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getCurrentUser = _ => {
            $.ajax({
                type: "POST",
                url: "station9.aspx/GetCurrentUser",
        ...
        const getJobCount = _ => {
            $.ajax({
                type: "POST",
                url: "station9.aspx/GET_JOB_COUNT",
        ...
        const getModelAndTaskList = _ => {
            $.ajax({
                type: "POST",
                url: "station9.aspx/GetModelAndTaskList",
        ...
        const buildTicketExecuteTask = (id, value) => {
            $.ajax({
                type: "POST",
                url: "station9.aspx/BuildTicketExecuteTask",
        ...
        const scanExecuteTask = (sid, sfg, sbom_seq, sval) => {
            $.ajax({
                type: "POST",
                url: "station9.aspx/ScanExecuteTask",
        ...
        const torqueExecuteTask = (id, torque_seq) => {  
            if (EntryPoint) {
                ...
                $.ajax({
                    type: "POST",
                    url: "station9.aspx/TorqueExecuteTask",
        ...
        const getAllPlcTagList = _ => {
            $.ajax({
                type: "POST",
                url: "station9.aspx/GetAllPlcTagList",
                data: "",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const writeBitExecuteTask = id => {
            $.ajax({
                type: "POST",
                url: "station9.aspx/WriteBitExecuteTask",
        ...
        const readBitExecuteTask = id => {
            $.ajax({
                type: "POST",
                url: "station9.aspx/ReadBitExecuteTask",
        ...
        function isPlcConnected() {
            $.ajax({
                type: "POST",
                url: "station9.aspx/IS_PLC_CONNECTED",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
