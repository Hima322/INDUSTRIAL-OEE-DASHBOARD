<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="station14.aspx.cs" Inherits="WebApplication2.station.Station14" %> 
...
<head runat="server">
    ...
    <script> 
        ...
        function handleTask() {  
            task_list.forEach(e => {  
                if (e.ImageSeq == 1) { 
                    ...
                    if (e.TaskType == "QrPrint" && (e.TaskStatus == "Running" || e.TaskStatus == "Error")) {
                        $("#qr_scan_modal").hide()
                        if (qrEntry) {
                            qrEntry = false
        ...
        const callStationInfo = _ => {
            $.ajax({
                type: "POST",
                url: "station14.aspx/GetStationInfo",
        ...
        const getCurrentUser = _ => {
            $.ajax({
                type: "POST",
                url: "station14.aspx/GetCurrentUser",
        ...
        const getModelAndTaskList = _ => {
            $.ajax({
                type: "POST",
                url: "station14.aspx/GetModelAndTaskList",
        ...
        const buildTicketExecuteTask = (id, value) => {
            $.ajax({
                type: "POST",
                url: "station14.aspx/BuildTicketExecuteTask",
        ...
        const qrPrintExecuteTask = id => {
            if (PrinterConnected) {
                $.ajax({
                    type: "POST",
                    url: "station14.aspx/QRCODE_PRINT",
                    data: `{id : '${id}', val:'${build_ticket}', model_variant : '${model_details.ModelVariant}', seat_data_id : '${seat_data_id}'}`,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: "true",
                    cache: "false",
        ...
        const getAllPlcTagList = _ => {
            $.ajax({
                type: "POST",
                url: "station14.aspx/GetAllPlcTagList",
                data: "",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const writeBitExecuteTask = id => {
            $.ajax({
                type: "POST",
                url: "station14.aspx/WriteBitExecuteTask",
        ...
        const isPrinterConnected = () => {
            $.ajax({
                type: "POST",
                url: "station14.aspx/ISPRINTERCONNECTED",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        function isPlcConnected() {
            $.ajax({
                type: "POST",
                url: "station14.aspx/IS_PLC_CONNECTED",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
                        ...
                        <tr>
                            <td colspan="5">
                                ...
                                <script>
                                    ...
                                    setInterval(function () { $("#build_ticket").focus() }, 1000)
                                </script>
                            </td>
                        </tr>
                    </tbody>
