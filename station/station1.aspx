<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="station1.aspx.cs" Inherits="WebApplication2.station.Station1" %> 
...
<head runat="server">
    ...
    <script> 
        ...
        const pageLoadFunction = _ => {
            $.ajax({
                type: "POST",
                url: "station1.aspx/PAGE_LOAD_FUNCTION",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const isConveyorAutoMode = _ => {
            $.ajax({
                type: "POST",
                url: "station1.aspx/IS_CONVEYOR_AUTO_MODE",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const callStationInfo = _ => {
            $.ajax({
                type: "POST",
                url: "station1.aspx/GetStationInfo",
                data: `{station : '${station}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getJobCount = _ => {
            $.ajax({
                type: "POST",
                url: "station1.aspx/GET_JOB_COUNT",
        ...
        const getModelAndTaskList = _ => {
            $.ajax({
                type: "POST",
                url: "station1.aspx/GetModelAndTaskList",
        ...
        const scanExecuteTask = (sid, sfg, sbom_seq, sval) => {
            $.ajax({
                type: "POST",
                url: "station1.aspx/ScanExecuteTask",
                data: `{id : '${sid}',fgpart : '${sfg}',bom:'${sbom_seq}',val:'${sval}', model_variant : '${model_details.ModelVariant}', seat_data_id:'${seat_data_id}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const torqueExecuteTask = (id, torque_seq) => {  
            if (EntryPoint) {
                ...
                $.ajax({
                    type: "POST",
                    url: "station1.aspx/TorqueExecuteTask",
        ...
        const getAllPlcTagList = _ => {
            $.ajax({
                type: "POST",
                url: "station1.aspx/GetAllPlcTagList",
                data: "",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const writeBitExecuteTask = id => {
            $.ajax({
                type: "POST",
                url: "station1.aspx/WriteBitExecuteTask",
        ...
        function isPlcConnected() {
            $.ajax({
                type: "POST",
                url: "station1.aspx/IS_PLC_CONNECTED",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
