<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stationfsb.aspx.cs" Inherits="WebApplication2.station.Stationfsb" %> 
...
<head runat="server">
    ...
    <script> 
        ...
        const isConveyorAutoMode = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsb.aspx/IS_CONVEYOR_AUTO_MODE",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getJobCount = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsb.aspx/GET_JOB_COUNT",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const ToolStatus = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsb.aspx/ToolStatus",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const pageLoadFunction = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsb.aspx/PAGE_LOAD_FUNCTION",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const callStationInfo = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsb.aspx/GetStationInfo",
                data: `{station : '${station}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getCurrentUser = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsb.aspx/GetCurrentUser",
        ...
        const getModelAndTaskList = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsb.aspx/GetModelAndTaskList",
        ...
        const buildTicketExecuteTask = (id, value) => {
            $.ajax({
                type: "POST",
                url: "stationfsb.aspx/BuildTicketExecuteTask",
        ...
        const scanExecuteTask = (sid, sfg, sbom_seq, sval) => {
            $.ajax({
                type: "POST",
                url: "stationfsb.aspx/ScanExecuteTask",
        ...
        const torqueExecuteTask = (id, torque_seq) => {  
            if (EntryPoint) {
                ...
                $.ajax({
                    type: "POST",
                    url: "stationfsb.aspx/TorqueExecuteTask",
        ...
        const finishTask = _ => { 
            $.ajax({
                type: "POST",
                url: "stationfsb.aspx/FinishTask",
        ...
        const rejectTask = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsb.aspx/RejectTask",
        ...
        function isPlcConnected() {
            $.ajax({
                type: "POST",
                url: "stationfsb.aspx/IS_PLC_CONNECTED",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        function isPingDctool() {
            $.ajax({
                type: "POST",
                url: "stationfsb.aspx/PING_DCTOOL",
                data: `{ip:'${dcToolIp}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
                ...
                <div id="auth_modal">
                    ...
                    <script> 
                        ...
                        function handleLogout() {
                            $.ajax({
                                type: "POST",
                                url: "stationfsb.aspx/UserLogout",
