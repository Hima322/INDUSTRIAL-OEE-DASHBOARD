...
{
    public partial class Stationfsb : Page
    {
        ...
        public static string IsQRValid(string build_ticket)
        {
            try
            {
                ...
                {
                    var res = dbEntities.SEAT_DATA.Where(i => i.BuildLabelBarcode == build_ticket && i.FSB == null).OrderByDescending(o => o.ID).FirstOrDefault();
                    if (res != null)
                    {
                        if (res.STAUS == "REJECT")
                        {
