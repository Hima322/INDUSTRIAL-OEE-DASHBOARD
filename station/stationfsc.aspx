<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stationfsc.aspx.cs" Inherits="WebApplication2.station.Stationfsc" %> 
...
<head runat="server">
    ...
    <script> 
        ...
        function handleTask() {
            task_list.forEach(e => {
                if (e.ImageSeq == 1 && (e.TaskStatus == "Running" || e.TaskStatus == "Error")) { 
                    ...
                    if (e.TaskType == "Torque" && (e.TaskStatus == "Running" || e.TaskStatus == "Error")) {
                        $("#qr_scan_modal").hide()
                        torqueExecuteTask(e.ID, e.BomSeq) 
                    }
                    if (!task_list.some(k => k.TaskCurrentValue == "") && task_list.every(k => k.TaskStatus == "Done")) {  
                        $("#qr_scan_modal").hide()
                        finishTask()
                    } 
                } 
        ...
        const getJobCount = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/GET_JOB_COUNT",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const isConveyorAutoMode = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/IS_CONVEYOR_AUTO_MODE",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const pageLoadFunction = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/PAGE_LOAD_FUNCTION",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getDcToolIp = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/GetDcToolIp",
        ...
        const ToolStatus = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/ToolStatus",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const callStationInfo = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/GetStationInfo",
                data: `{station : '${station}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getCurrentUser = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/GetCurrentUser",
                data: `{station : '${station.replace("Station-", "")}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
                cache: "false",
        ...
        const getModelAndTaskList = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/GetModelAndTaskList",
        ...
        const buildTicketExecuteTask = (id, value) => {
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/BuildTicketExecuteTask",
                data: `{id : '${id}',val:'${value}', model_variant : '${model_details.ModelVariant}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
                cache: "false",
        ...
        const scanExecuteTask = (sid, sfg, sbom_seq, sval) => {
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/ScanExecuteTask",
        ...
        const torqueExecuteTask = (id, torque_seq) => {  
            if (EntryPoint) {
                ...
                $.ajax({
                    type: "POST",
                    url: "stationfsc.aspx/TorqueExecuteTask",
        ...
        const finishTask = _ => { 
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/FinishTask",
        ...
        const rejectTask = _ => {
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/RejectTask",
        ...
        function isPlcConnected() {
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/IS_PLC_CONNECTED",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        function isPingDctool() {
            $.ajax({
                type: "POST",
                url: "stationfsc.aspx/PING_DCTOOL",
                data: `{ip:'${dcToolIp}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
                    ...
                    <script> 
                        $("#user_login_id").on("keyup", function (e) {
                            ...
                            if (e.key == "Enter") {
                                $.ajax({
                                    type: "POST",
                                    url: "stationfsc.aspx/UserLogin",
                                    data: `{ Userid: '${user_login_id}',Station: '${station.replace("Station-", "")}'}`,
                                    contentType: "application/json; charset=utf-8",
                                    dataType: "json",
                                    async: "true",
                                    cache: "false",
                        ...
                        function handleLogout() {
                            $.ajax({
                                type: "POST",
                                url: "stationfsc.aspx/UserLogout",
                                data: `{ Userid: '${user_details.UserID}',Station: '${station.replace("Station-", "")}'}`,
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                async: "true",
                                cache: "false",
