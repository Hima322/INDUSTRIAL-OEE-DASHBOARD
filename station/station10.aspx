<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="station10.aspx.cs" Inherits="WebApplication2.station.Station10" %> 
...
<head runat="server">
    ...
    <script> 
        ...
        const getDcToolIp = _ => {
            $.ajax({
                type: "POST",
                url: "station10.aspx/GetDcToolIp",
        ...
        const getJobCount = _ => {
            $.ajax({
                type: "POST",
                url: "station10.aspx/GET_JOB_COUNT",
        ...
        const callStationInfo = _ => {
            $.ajax({
                type: "POST",
                url: "station10.aspx/GetStationInfo",
                data: `{station : '${station}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getCurrentUser = _ => {
            $.ajax({
                type: "POST",
                url: "station10.aspx/GetCurrentUser",
        ...
        const getModelAndTaskList = _ => {
            $.ajax({
                type: "POST",
                url: "station10.aspx/GetModelAndTaskList",
        ...
        const buildTicketExecuteTask = (id, value) => {
            $.ajax({
                type: "POST",
                url: "station10.aspx/BuildTicketExecuteTask",
        ...
        const scanExecuteTask = (sid, sfg, sbom_seq, sval) => {
            $.ajax({
                type: "POST",
                url: "station10.aspx/ScanExecuteTask",
        ...
        const torqueExecuteTask = (id, torque_seq) => {  
            if (EntryPoint) {
                ...
                $.ajax({
                    type: "POST",
                    url: "station10.aspx/TorqueExecuteTask",
        ...
        const getAllPlcTagList = _ => {
            $.ajax({
                type: "POST",
                url: "station10.aspx/GetAllPlcTagList",
                data: "",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const writeBitExecuteTask = id => {
            $.ajax({
                type: "POST",
                url: "station10.aspx/WriteBitExecuteTask",
        ...
        const readBitExecuteTask = id => {
            $.ajax({
                type: "POST",
                url: "station10.aspx/ReadBitExecuteTask",
        ...
        function isPlcConnected() {
            $.ajax({
                type: "POST",
                url: "station10.aspx/IS_PLC_CONNECTED",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        function isPingDctool() {
            $.ajax({
                type: "POST",
                url: "station10.aspx/PING_DCTOOL",
                data: `{ip:'${dcToolIp}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
