<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="station15.aspx.cs" Inherits="WebApplication2.station.Station15" %> 
...
<head runat="server">
    ...
    <script> 
        ...
        const getDcToolIp = _ => {
            $.ajax({
                type: "POST",
                url: "station15.aspx/GetDcToolIp",
        ...
        const callStationInfo = _ => {
            $.ajax({
                type: "POST",
                url: "station15.aspx/GetStationInfo",
                data: `{station : '${station}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getCurrentUser = _ => {
            $.ajax({
                type: "POST",
                url: "station15.aspx/GetCurrentUser",
        ...
        const getModelAndTaskList = _ => {
            $.ajax({
                type: "POST",
                url: "station15.aspx/GetModelAndTaskList",
        ...
        const buildTicketExecuteTask = (id, value) => {
            $.ajax({
                type: "POST",
                url: "station15.aspx/BuildTicketExecuteTask",
        ...
        const scanExecuteTask = (sid, sfg, sbom_seq, sval) => {
            $.ajax({
                type: "POST",
                url: "station15.aspx/ScanExecuteTask",
        ...
        const torqueExecuteTask = (id, torque_seq) => {  
            if (EntryPoint) {
                ...
                $.ajax({
                    type: "POST",
                    url: "station15.aspx/TorqueExecuteTask",
        ...
        const getAllPlcTagList = _ => {
            $.ajax({
                type: "POST",
                url: "station15.aspx/GetAllPlcTagList",
                data: "",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const writeBitExecuteTask = id => {
            $.ajax({
                type: "POST",
                url: "station15.aspx/WriteBitExecuteTask",
        ...
        const readBitExecuteTask = id => {
            $.ajax({
                type: "POST",
                url: "station15.aspx/ReadBitExecuteTask",
        ...
        function isPlcConnected() {
            $.ajax({
                type: "POST",
                url: "station15.aspx/IS_PLC_CONNECTED",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        function isPingDctool() {
            $.ajax({
                type: "POST",
                url: "station15.aspx/PING_DCTOOL",
                data: `{ip:'${dcToolIp}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
