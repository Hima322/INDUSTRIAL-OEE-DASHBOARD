<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="station6.aspx.cs" Inherits="WebApplication2.station.Station6" %> 
...
<head runat="server">
    ...
    <script> 
        ...
        const isConveyorAutoMode = _ => {
            $.ajax({
                type: "POST",
                url: "station6.aspx/IS_CONVEYOR_AUTO_MODE",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const pageLoadFunction = _ => {
            $.ajax({
                type: "POST",
                url: "station6.aspx/PAGE_LOAD_FUNCTION",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getJobCount = _ => {
            $.ajax({
                type: "POST",
                url: "station6.aspx/GET_JOB_COUNT",
        ...
        const callStationInfo = _ => {
            $.ajax({
                type: "POST",
                url: "station6.aspx/GetStationInfo",
                data: `{station : '${station}'}`,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const getCurrentUser = _ => {
            $.ajax({
                type: "POST",
                url: "station6.aspx/GetCurrentUser",
        ...
        const getModelAndTaskList = _ => {
            $.ajax({
                type: "POST",
                url: "station6.aspx/GetModelAndTaskList",
        ...
        const buildTicketExecuteTask = (id, value) => {
            $.ajax({
                type: "POST",
                url: "station6.aspx/BuildTicketExecuteTask",
        ...
        const torqueExecuteTask = (id, torque_seq) => {  
            if (EntryPoint) {
                ...
                $.ajax({
                    type: "POST",
                    url: "station6.aspx/TorqueExecuteTask",
        ...
        const getAllPlcTagList = _ => {
            $.ajax({
                type: "POST",
                url: "station6.aspx/GetAllPlcTagList",
                data: "",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
        ...
        const writeBitExecuteTask = id => {
            $.ajax({
                type: "POST",
                url: "station6.aspx/WriteBitExecuteTask",
        ...
        function isPlcConnected() {
            $.ajax({
                type: "POST",
                url: "station6.aspx/IS_PLC_CONNECTED",
                data: ``,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
